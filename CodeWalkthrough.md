...
## 2. The Shared Base Class ([Shared/RabbitMqConsumerBase.cs](Shared/RabbitMqConsumerBase.cs))
...
## 3. The Consumer Implementation ([Consumer1/Program.cs](Consumer1/Program.cs))
...
## 4. The Producer ([Producer/Program.cs](Producer/Program.cs))
...
## Summary of Workflow
1. You run [Start-Environment.ps1](Start-Environment.ps1).
